export const ARTICLES = [
  {
    slug: "panduan-memilih-talent-luxury-villa-party-bali",
    title: "Panduan Memilih Entertainment Talent untuk Luxury Villa Party di Bali",
    excerpt: "Mengadakan private party di villa mewah Bali membutuhkan standar hiburan yang tepat. Temukan rahasia memilih talent eksklusif yang akan memukau tamu VIP Anda.",
    content: `
      <p>Bali telah lama menjadi destinasi utama untuk penyelenggaraan <em>private party</em> berskala internasional. Dari kawasan tebing Uluwatu hingga kemewahan Canggu, sebuah <strong>luxury villa party</strong> tidak akan lengkap tanpa kehadiran entertainment talent kelas atas.</p>
      <br/>
      <h3 class="text-xl text-gold font-semibold mb-2">1. Pahami Tema dan Profil Tamu VIP Anda</h3>
      <p>Langkah pertama adalah menyesuaikan talent dengan suasana yang ingin dibangun. Untuk acara yang elegan dan santai di sore hari, kehadiran <strong>Acoustic Band</strong> atau <strong>Belly Dancer</strong> dapat memberikan nuansa eksotis yang tidak berlebihan. Namun, jika targetnya adalah puncak acara di malam hari, <strong>Fire Dance</strong> atau <strong>LED Dancer</strong> adalah pilihan mutlak untuk menciptakan momen tak terlupakan.</p>
      <br/>
      <h3 class="text-xl text-gold font-semibold mb-2">2. Standar Profesionalisme dan Keamanan</h3>
  ...
  {
    slug: "alasan-fire-dance-wajib-untuk-beach-club-bali",
    title: "Mengapa Fire Dance Menjadi Hiburan Wajib untuk Beach Club Event di Bali",
    excerpt: "Daya tarik visual yang dramatis dan energi magis dari tarian api selalu berhasil menjadi puncak acara di berbagai beach club ternama di Bali. Inilah alasannya.",
    content: `
      <p>Jika ada satu pertunjukan yang mendefinisikan kehidupan malam pesisir di Pulau Dewata, itu adalah <strong>Fire Dance Bali</strong>. Tidak ada event beach club yang benar-benar mencapai puncaknya tanpa kilatan api yang menari di bawah langit malam.</p>
      <br/>
      <h3 class="text-xl text-gold font-semibold mb-2">Magnet Visual Pencipta Konten (UGC)</h3>
      <p>Di era media sosial, tamu Anda adalah promotor terbaik Anda. Pertunjukan Fire Dance secara otomatis akan memicu ratusan kamera ponsel terangkat. Efek visual yang kontras antara gelapnya malam pantai dan terangnya nyala api menciptakan <em>User Generated Content (UGC)</em> yang sangat estetik untuk Instagram dan TikTok. Ini adalah marketing gratis untuk event Anda.</p>
      <br/>
      <h3 class="text-xl text-gold font-semibold mb-2">Membangun Adrenalin dan Energi Puncak</h3>
      <p>Berbeda dengan tarian biasa, Fire Dance melibatkan elemen bahaya yang terkontrol. Hal ini secara psikologis memompa adrenalin penonton, membuat mereka lebih bersemangat, lebih banyak memesan minuman, dan lebih menikmati alunan musik dari DJ. Tarian ini bertindak sebagai <em>hype-builder</em> yang sempurna sebelum DJ utama naik ke panggung.</p>
      <br/>
  ...
  {
    slug: "magisnya-tari-tradisional-bali-untuk-corporate-gathering",
    title: "Menghadirkan Sentuhan Magis Tari Tradisional Bali untuk Corporate Gathering",
    excerpt: "Berikan impresi mendalam bagi klien dan karyawan perusahaan Anda melalui keindahan magis dan nilai sakral dari Balinese Traditional Dance.",
    content: `
      <p>Banyak perusahaan multinasional yang memilih Bali sebagai destinasi <strong>Corporate Gathering</strong> atau <strong>Gala Dinner</strong> mereka. Untuk memberikan pengalaman autentik yang berkelas, mengintegrasikan <strong>Tari Tradisional Bali</strong> ke dalam susunan acara adalah sebuah langkah strategis.</p>
      <br/>
